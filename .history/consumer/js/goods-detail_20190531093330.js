        ...
        initPhotoPreview() {
            ...
            this.photoPreview = $.photoBrowser({
                ...
                <div class="weui-photo-browser-modal">
                    <div class="swiper-container">
                        ...
                        <span class="preview-num">
                            {{currentPreviewIndex}} / {{items.length}}
                        </span>
                        <div class="swiper-pagination swiper-pagination-bullets"> {{#items}} <span class="swiper-pagination-bullet"></span>
                            {{/items}} </div>
                    </div>
                </div>
                `,
                ...
                onSlideChange: function (index) {
                    ...
                    console.log(this.currentPreviewIndex);
                }
            });
